    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="tw-block tw-mt-4">
            <label for="remember_me" class="tw-inline-flex tw-items-center">
                <input id="remember_me" type="checkbox" class="tw-rounded tw-border-gray  tw-text-indigo-600 tw-shadow-sm focus:tw-ring-indigo-500" name="remember">
        ...
        <div class="tw-flex tw-items-center tw-justify-end tw-mt-4">
            @if (Route::has('password.request'))
                <a class="tw-underline tw-text-sm tw-text-gray hover:tw-no-underline" href="{{ route('password.request') }}">
