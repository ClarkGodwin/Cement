...
<body class=" tw-bg-gray dark:tw-bg-black_blue dark">
    ...
    <section class=" tw-border-[5px] tw-border-white tw-bg-white dark:tw-bg-purple_blue tw-w-[1200px] tw-mx-auto tw-mt-[100px] tw-h-[700px] tw-mb-[100px] tw-flex tw-rounded-triple">
        <div class=" tw-bg-white dark:tw-bg-purple_blue tw-w-[20%] tw-h-full tw-rounded-l-triple"></div>

        <div class=" tw-bg-gray dark:tw-bg-black_blue tw-w-[80%] tw-h-full tw-rounded-r-triple">
