@if (session("success"))
<div class=" tw-w-[95%] sm:tw-w-[90%] tw-text-white tw-font-bold tw-font-raleway tw-text-[15px] sm:tw-text-[17px] md:tw-text-[20px] tw-bg-green tw-p-4 tw-rounded-default tw-mt-5">
    {{session("success")}}
</div>
@endif
